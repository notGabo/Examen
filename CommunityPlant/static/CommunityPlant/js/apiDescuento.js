        ...
        type: "GET",
            success: function(resultado){
                for (elem of resultado){
                    ...
                    buttonSuccess = "<button type='button' class='btn btn-outline-success' name='checkDescuento' id='checkDescuento'>Descuento del <span id='valorDescuento'>"+elem.Porcentaje+"</span>% a sido aplicado</button>";
